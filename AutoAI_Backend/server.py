...
def index():
    ...
    API_KEY = "8tssLsbjkKhkrrqnBJG0C6DzjLTTg7V2rxUA6-PeJgHx"
    ...
    response_scoring = requests.post('https://eu-gb.ml.cloud.ibm.com/ml/v4/deployments/77902efb-6aed-4a52-800a-54ec2cd1f8c5/predictions?version=2021-09-19', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
    dictionary ={ 
    "status": "200", 
